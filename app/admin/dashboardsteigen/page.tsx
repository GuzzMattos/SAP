...
import { getAllInvestiments, getInvestimentsByClientId, TInvestimentsByClientId } from "@/app/_actions/investiment";
    ...
    useEffect(() => {
        async function fetchInvestimentos() {
            try {
                ...
                const investments = await getAllInvestiments(); // Remover o uso de client ID
        ...
        fetchInvestimentos();
    }, []); // Remover a dependência `selectedClient`
