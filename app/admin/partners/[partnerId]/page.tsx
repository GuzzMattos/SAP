...
export default function SinglePartnerPage({ params }: { params: { partnerId: string } }) {
    ...
    return (
        ...
        <div className="flex justify-between items-center mb-4">
            <span className="text-black font-bold pb-3 text-3xl">Detalhes do Parceiro</span>
                ...
                {activeTab === "Detalhes" && (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <Input id="tipo" value={partner.tipo} className="bg-gray-100 text-gray-800" readOnly />
                        </div>
