        ...
        <main className="bg-gray-50 min-h-screen p-6 flex justify-center items-center">
            <div className="bg-white p-8 shadow-md rounded-lg w-full max-w-2xl">
                <div className="flex items-center justify-between mb-4">
                    <RouterBackButton />
                    <div className="text-gray-700 font-bold pb-3 text-3xl">Adicionar Familiar</div>

                    <HelperDialog title="Ajuda">
                        <div>
                            {/* Conteúdo da ajuda aqui */}
                            Insira os dados do familiar para criar um novo registro. Verifique se todos os campos estão corretos antes de enviar.
                        </div>
                    </HelperDialog>
                </div>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-col">
                                    <FormLabel className=" text-gray-800 mb-2 flex">CPF<div className="text-red-600">*</div></FormLabel>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className="text-gray-800 flex">Parentesco <div className="text-red-600">*</div></FormLabel>
                                    <FormControl>
                                        <select
                                            className="bg-gray-100 text-gray-800 text-sm border border-gray-300 rounded-md p-2 w-full mt-1"
                                            value={field.value}
